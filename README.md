...
```
    ...
    Fetching geodataframes took 5.99 seconds
...
```
    ...
    Fetching geodataframes took 28.28 seconds
...
```
    ...
    Fetching geodataframes took 13.82 seconds
...
```
    ...
    Fetching geodataframes took 12.82 seconds
...
```
    ...
    Fetching geodataframes took 12.28 seconds
...
```
    ...
    Fetching geodataframes took 3.99 seconds
...
```
    ...
    Fetching geodataframes took 27.47 seconds
...
```
    ...
    Fetching geodataframes took 8.40 seconds


    Fetching geodataframes took 6.57 seconds


    Fetching geodataframes took 8.01 seconds
...
```
    ...
    Fetching geodataframes took 46.80 seconds
    ...
    make: Leaving directory '/home/runner/work/prettymaps/prettymaps/notebooks/SRTM1'
    make: Entering directory '/home/runner/work/prettymaps/prettymaps/notebooks/SRTM1'
    cp SRTM1.vrt SRTM1.3c6f26feda47454b8e5fcad6614251a5.vrt
    make: Leaving directory '/home/runner/work/prettymaps/prettymaps/notebooks/SRTM1'
    make: Entering directory '/home/runner/work/prettymaps/prettymaps/notebooks/SRTM1'
    gdal_translate -q -co TILED=YES -co COMPRESS=DEFLATE -co ZLEVEL=9 -co PREDICTOR=2 -projwin -157.90125854957773 21.364471426268267 -157.81006761682832 21.244615177105388 SRTM1.3c6f26feda47454b8e5fcad6614251a5.vrt /home/runner/work/prettymaps/prettymaps/notebooks/elevation.tif
    rm -f SRTM1.3c6f26feda47454b8e5fcad6614251a5.vrt
    make: Leaving directory '/home/runner/work/prettymaps/prettymaps/notebooks/SRTM1'
...
```
    ...
    Fetching geodataframes took 20.11 seconds
